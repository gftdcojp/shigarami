...
import { CompatibilityIssue, CompatibilityQuery } from '../types/compatibility.js';
...
export class CLI {
   ...
   */
  async searchCompatibility(query: string | undefined, options: CLIOptions): Promise<void> {
