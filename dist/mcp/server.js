...
const CompatibilityDatabaseLive = Layer.succeed(CompatibilityDatabase, null // Will be provided when starting
);
// MCP Tools
const listTools = () => [
    {
...
const handleToolCall = (db, name, args) => Effect.gen(function* (_) {
    switch (name) {
        ...
        case 'report_compatibility_issue': {
            ...
            const issue = {
                ...
                source: 'manual', // MCP reports are treated as manual for now
...
export const startMCPServer = (db) => Effect.gen(function* (_) {
