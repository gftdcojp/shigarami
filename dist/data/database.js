...
import { CompatibilityIssueSchema, } from '../types/compatibility.js';
export class CompatibilityDatabaseManager {
    ...
    async queryIssues(query) {
        ...
        if (query.lib) {
            issues = issues.filter(i => i.libs && Object.keys(i.libs).some(lib => lib.includes(query.lib) ||
